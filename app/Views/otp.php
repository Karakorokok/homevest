...
<head>
    ...
    <title>Home Vest - Agent Register</title>
            ...
            <form action="/otp" method="POST">
                ...
                <div data-mdb-input-init class="form-outline mb-1">
                    <input type="text" class="form-control form-control-lg" name="otp" 
                        value="<?= esc($formData['otp'] ?? '') ?>"/>
                    <label class="form-label">OTP</label>
                </div>
                <small>Enter the OTP that was sent to your email.</small>
                <div class="mb-1"></div>
                ...
                <button  type="submit" class="btn btn-primary btn-lg btn-block mt-5 mb-4">Create agent account</button>

                <div class="text-center">
                    <p><a href="/login">Clik here to login</a></p>
                </div>
